...
public class ReservationInputForm {
	 ...
	 // チェックイン日とチェックアウト日が同じかどうかを判定する
	 public boolean isSameDate () {
		 	String date = getFromCheckinDateToCheckoutDate();
		 	if (date == null) return false;
		 	String[] checkinDateAndCheckoutDate = date.split(" から ");
		 	return checkinDateAndCheckoutDate.length == 1;
